...
Olá!<br>
Me chamo Sisley e vou detalhar um pouco sobre o segundo Desafio do Bootcamp da Dio. Foi solicitada a criação de uma planilha para ajudar o usuário na Declaração de Imposto de Renda, aplicando os conceitos de Excel no desenvolvimento dessa ferramenta. A seguir, detalho como foi feito o passo a passo dessa ferramenta.<br>

## 📌 Objetivo
Aplicar os conceitos de Excel no desenvolvimento de uma ferramenta prática  de Organização de Declaração de Imposto de Renda<br>
...
Por que isso está sendo feito? Resposta: Para ajudar o usuário a se organizar na Declaração de Imposto de Renda. <br>
Quais os blocos e informações eu preciso incluir nessa ferramenta para fazer essas simulações? <br>
